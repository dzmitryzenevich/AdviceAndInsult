...
class GetAllInsultFromDatabaseUseCase(private val insultRepository: InsultRepository) {

    fun execute(): Flow<List<InsultGetDB>> = insultRepository.getAllInsultFromDatabase()
}